 ...
 * @author lucas
 */
public class frmEditIngrediente extends javax.swing.JFrame {

    /**
     * Creates new form frmEditIngrediente
     */
    public frmEditIngrediente() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Categoria do ingrediente");
 ...
 String caminhoImagem;
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        Ingredientes tipo = (Ingredientes) jComboBox1.getSelectedItem();
        con = new ClasseConexaoJava();
        boolean resultado = con.conectar();
        if (resultado == true){
            try{

                PreparedStatement patmt = con.getConn().prepareStatement("update tbIngrediente set categoriaIngredienteID = ?, ingredienteNome=?,ingredienteCusto=?,ingredienteDescricao=?, ingredienteFoto=? where ingredienteID =?") ;

                patmt.setInt(1,tipo.getIdIngrediente());
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        if (resultado == true){
            try{
                ...
                PreparedStatement patmt = con.getConn().prepareStatement("select * from tbIngrediente where ingredienteID =?") ;
                ...
                JOptionPane.showMessageDialog(null,"ingrediente buscado");
                patmt.close();
                con.desconectar();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmEditIngrediente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmEditIngrediente().setVisible(true);
            }
        });
    }
