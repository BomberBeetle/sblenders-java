 ...
 * @author lucas
 */
public class frmCadAgenteFunc extends frmNovoAgente {

    /**
     * Creates new form frmCadAgenteFunc
     */
    public frmCadAgenteFunc() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(698, 586));
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        JOptionPane.showMessageDialog(null,"agente cadastrado, começando cadastro de funcionário");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmCadAgenteFunc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmCadAgenteFunc().setVisible(true);
            }
        });
    }
